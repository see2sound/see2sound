...
from .modules_video import ContinuousPositionBias, FeedForward, SpatioTemporalAttention
...
class CLIPEncoderLayer(nn.Module):
    def __init__(self, config: CLIPConfig, add_temporal_attention: bool = False):
        ...
        if add_temporal_attention:
            self.temporal_self_attn = SpatioTemporalAttention(
                dim=self.embed_dim,
...
class CLIPEncoder(nn.Module):
    ...
    def __init__(self, config: CLIPConfig, add_temporal_attention: bool = False):
        ...
        self.layers = nn.ModuleList(
            [
                CLIPEncoderLayer(config, add_temporal_attention=add_temporal_attention)
...
class CLIPVisionTransformer(nn.Module):
    def __init__(self, config: CLIPVisionConfig, add_temporal_attention: bool):
        ...
        self.encoder = CLIPEncoder(
            config, add_temporal_attention=add_temporal_attention
        )
...
class CLIPModel(CLIPPreTrainedModel):
    ...
    def __init__(self, config: CLIPConfig, add_temporal_attention: bool = False):
        ...
        self.vision_model = CLIPVisionTransformer(
            vision_config, add_temporal_attention=add_temporal_attention
        )
